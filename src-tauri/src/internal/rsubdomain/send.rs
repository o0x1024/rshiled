...
use super::model::{EthTable, StatusTable};
use super::structs::{LOCAL_STACK, LOCAL_STATUS};
...
impl SendDog {
    ...
    pub fn build_status_table(&mut self, domain: &str, dns: &str, domain_level: i32) -> (u16, u16) {
